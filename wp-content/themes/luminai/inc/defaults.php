...
$luminai_theme_divider_style = array(
...
$luminai_theme_action_button           = __( 'Embrace Today!', 'luminai' );
$luminai_theme_action_button_secondary = __( 'Contact us', 'luminai' );

$luminai_theme_click_pen_to_edit_title = __( 'Enhancing Experiences, Enabling Connections', 'luminai' );
$luminai_lorem_ipsum                   = __('Explore endless possibilities with us. Unlock innovation, pursue excellence, and redefine your digital journey. Step into a realm where every click unveils new horizons.', 'luminai');


return array(
	'default_icon'                 => $luminai_theme_svg_icons['fort-awesome'],
	'icons'                        => $luminai_theme_svg_icons,
	'divider_style'                => $luminai_theme_divider_style,
	'lorem_ipsum'                  => $luminai_lorem_ipsum,
	'edit_this_text_in_customizer' => $luminai_theme_click_pen_to_edit_title,
	'gradients'                    => $luminai_gradients,
	...
	'front-header' => array(
		...
		'buttons'      => array(
			...
			'value' => array(
				array(
					'label'       => sprintf( $luminai_theme_action_button, 1 ),
					'url'         => '#',
					'button_type' => '0',
					'index'       => 0,
				),
				array(
					'label'       => sprintf( $luminai_theme_action_button_secondary, 1 ),
					'url'         => '#',
					'button_type' => '1',
					'index'       => 1,
				),
		...
		'title'        => array(
			'show'  => true,
			'value' => $luminai_theme_click_pen_to_edit_title,
			'style' => array(
				'descendants' => array(
					'text' => array(
						'textAlign' => 'center',
						...
						'background' => array(
							...
							'overlay'   =>
								array(
									...
									'gradient'         => $luminai_gradients['front_header_default_overlay'],
									'gradient_opacity' => 50,
									'shape'            =>
										array(
											'value'  => 'none',
							...
							'image'     => array(
								array(
									'source'     => array(
										...
										'gradient' => $luminai_gradients['night_fade'],
									),
		...
		'social_icons' => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $luminai_theme_svg_icons['facebook-square'],
						'link_value' => '#',
						'index'      => 0,
					),
					array(
						'icon'       => $luminai_theme_svg_icons['whatsapp-square'],
						'link_value' => '#',
						'index'      => 1,
					),
					array(
						'icon'       => $luminai_theme_svg_icons['youtube-play'],
						'link_value' => '#',
						'index'      => 2,
					),
                    array(
                        'icon'       => $luminai_theme_svg_icons['yahoo-square'],
                        'link_value' => '#',
                        'index'      => 3,
                    ),
				),
		...
		'icon_list'    => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $luminai_theme_svg_icons['phone'],
						'text'       => 'CALL US TODAY: +00 900 900 900',
						'link_value' => 'tel:+00 900 900 900',
						'index'      => 0,
					),
					array(
						'icon'       => $luminai_theme_svg_icons['envelope'],
	...
	'header'                            => array(
						...
						'background' => array(
							...
							'overlay'   =>
								array(
									...
									'gradient'         => $luminai_gradients['inner_header_default_overlay'],
									'gradient_opacity' => 40,
									'shape'            =>
										array(
											'value'  => 'none',
		...
		'social_icons' => array(
			...
			'localProps' => array(
				'icons' => array(
					array(
						'icon'       => $luminai_theme_svg_icons['facebook'],
						'link_value' => '#',
						'index'      => 0,
					),
					array(
					...
					array(
						'icon'       => $luminai_theme_svg_icons['youtube'],
						'link_value' => '#',
						'index'      => 2,
					),
					array(
		...
		'icon_list'    => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $luminai_theme_svg_icons['map-pin'],
						'text'       => '1557 Frosty Lane, Binghamton, NY',
						'link_value' => '#',
						'index'      => 0,
					),
					array(
						'icon'       => $luminai_theme_svg_icons['phone-square'],
	...
	'blog_post_thumb_placeholder_color' => 'rgb(176,196,177)',
