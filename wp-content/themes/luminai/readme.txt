...
LuminAI is an innovative,  easily customizable, multi-purpose theme, focused on empowering users to build astonishing WordPress websites. LuminAI is mainly designed for small businesses, startups, or personal portfolio websites and works perfectly with Kubio Page Builder which enriches the WordPress block editor with a variety of new blocks and advanced styling options to give you full design freedom.

== Frequently Asked Questions ==

= How can I customize LuminAI? =

    To customize the LuminAI theme you have to open the Customizer by accessing the Appearance menu -> Customizer.

== License ==

LuminAI WordPress theme, Copyright (C) 2021 ExtendThemes
LuminAI WordPress theme is licensed under the GPL3.
...
- Google Fonts:
  ...
  Space Grotesk (https://fonts.google.com/specimen/Prompt)
  Licensed under SIL Open Font License, 1.1 (https://scripts.sil.org/cms/scripts/page.php?site_id=nrsi&id=OFL)
