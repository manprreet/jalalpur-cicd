...
wp_localize_script(
	...
	array(
		...
		'builderStatusData' => array(
			'status'       => luminai_theme()->getPluginsManager()->getPluginState( luminai_get_builder_plugin_slug() ),
			'install_url'  => luminai_theme()->getPluginsManager()->getInstallLink( luminai_get_builder_plugin_slug() ),
			'activate_url' => luminai_theme()->getPluginsManager()->getActivationLink( luminai_get_builder_plugin_slug() ),
			'slug'         => luminai_get_builder_plugin_slug(),
...
<div class="luminai-notice-dont-show-container">
    <button class="button-link luminai-dont-show-notice">
        <?php Translations::escHtmlE( 'dont_show_anymore' ); ?>
    </button>
</div>

<div class="luminai-admin-notice-spacer">
	<div class="luminai-admin-big-notice--container">
		<div class="content-holder">
            <div class="messages-area">
                <div class="title-holder">
                    <h1><?php Translations::escHtmlE( 'would_you_like_to_install_front_page', luminai_theme()->getName() ); ?></h1>
                    <p><?php Translations::escHtmlE( 'theme_description', luminai_theme()->getName() ); ?></p>
                </div>

                <ul>
                    <li>
                        <img src="<?php echo luminai_theme()->getListMarkerUrl()?>" alt="">
			...
			<div class="front-page-preview">
                <img src="<?php echo esc_url( luminai_theme()->getFrontPagePreview() ); ?>"/>
			</div>
		</div>
	</div>
</div>
